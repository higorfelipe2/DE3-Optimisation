...
% Higor comments:
% This is a variation of polyfitn, and is used to develop a higher order
% polynomial multivariate regression model
% Below code, except line 278 which turns RMSE into percentage of mean is 
% by John D'Errico, code provided in Mathsworks File Exchange
...
polymodel.RMSEpc = (polymodel.RMSE/mean(depvar))*100
